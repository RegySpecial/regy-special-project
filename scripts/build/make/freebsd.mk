...
386-a-goImageLibrary = bin/lib/static/a/go/elf/freebsd/386/CImage.a

build-386-a-goImageLibrary: $(goImageLibrary)
	GOOS=freebsd GOARCH=386 go build -buildmode=c-archive -o $(goImageLibrary) $(386-a-goImageLibrary)
	mv bin/lib/static/a/elf/freebsd/386/Cimage.h src/include/lib/go

amd64-a-goImageLibrary = bin/lib/static/a/go/elf/freebsd/amd64/CImage.a

build-amd64-a-goImageLibrary: $(goImageLibrary)
	GOOS=freebsd GOARCH=amd64 go build -buildmode=c-archive -o $(goImageLibrary) $(amd64-a-goImageLibrary)
	mv bin/lib/static/a/elf/freebsd/amd64/Cimage.h src/include/lib/go

arm-a-goImageLibrary = bin/lib/static/a/go/elf/freebsd/arm/CImage.a

build-arm-a-goImageLibrary: $(goImageLibrary)
	GOOS=freebsd GOARCH=arm go build -buildmode=c-archive -o $(goImageLibrary) $(arm-a-goImageLibrary)
	mv bin/lib/static/a/elf/freebsd/arm/Cimage.h src/include/lib/go

arm64-a-goImageLibrary = bin/lib/static/a/go/elf/freebsd/arm64/CImage.a

build-arm64-a-goImageLibrary: $(goImageLibrary)
	GOOS=freebsd GOARCH=arm64 go build -buildmode=c-archive -o $(goImageLibrary) $(arm64-a-goImageLibrary)
